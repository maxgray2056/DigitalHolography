# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 01:40:10 2024
...
def DIH_v32(image_path, z, mylamda, epoch):
    ...
    img = image_norm(image_path, image_size)
    ...
    imsave('./holo_'+str(z)+'_'+str(wavelength)+'_'+format_time+'.bmp', np.uint8(np.squeeze(hologram)*255))
    imsave('./bp_'  +str(z)+'_'+str(wavelength)+'_'+format_time+'.bmp', np.uint8(np.squeeze(np.abs(bp))*255))
    imsave('./bp_real_'+str(z)+'_'+str(wavelength)+'_'+format_time+'.bmp', np.uint8(np.squeeze(np.real(bp))*255))
    imsave('./bp_imag_'+str(z)+'_'+str(wavelength)+'_'+format_time+'.bmp', np.uint8(np.squeeze(np.imag(bp))*255))
...
if __name__ == '__main__':
    ...
    DIH_v32('1951usaf_1000x1000.jpg', z=12000, mylamda=0, epoch=1500)    
